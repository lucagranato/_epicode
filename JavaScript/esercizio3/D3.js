  ...
  switch (starWarsCharacters[i].eye_color){
    ...
    case 'blue-gray':
      eyeColor.blue_gray.push(starWarsCharacters[i].name)
       break;
    default:
      console.log('Colore occhi non rilevato.')
  }
};
...
// Modifica della massa di un personaggio e ricalcolo massa totale
crewMass = 0;
i=0; 

starWarsCharacters[2].mass = 2;
starWarsCharacters[3].mass = 1;
...
for (i = 0; i < starWarsCharacters.length; i++){
  if(starWarsCharacters[i].gender === "n/a"){
    starWarsCharacters[i].gender = "robot"; // faccio assegnazione diretta e non replace perchè replace agisce su una copia di memoria, non su originale
  }
}
...
console.log('Array originale', starWarsCharacters)
console.log('Array aggiornato', updateCharacters)
...
console.log('Dopo della modifica: ' + charactersNames.length)
...
// console.log('Ciao, sono ' + starWarsCharacters[randomIndex].name + ' sono alto ' + starWarsCharacters[randomIndex].height + ' cm, etc...')

// oppure, abbreviato, per associazioni

let randomIndex = 3;
let randomCharacter = starWarsCharacters[randomIndex];
console.log('Ciao, sono ' + randomCharacter.name + ' sono alto ' + randomCharacter.height + ' cm, etc...')